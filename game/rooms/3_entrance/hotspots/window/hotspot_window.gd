...
@export var window_sprite : PopochiuProp
...
func toggle_open_close():
	if isClosed:
		#window_sprite.current_frame = 1
		window_sprite.change_frame(0)
	else:
		#window_sprite.current_frame = 0;
		window_sprite.change_frame(1)
